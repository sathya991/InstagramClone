...
const ProfileHeader = () => {
    ...
    const visitingAnotherProfeandAuth = authUser && authUser.username !== userProfile.username;
    ...
    return (
        <Flex gap={{ base: 4, sm: 10 }} py={10} direction={{ base: "column", sm: "row" }}>
            <AvatarGroup
                ...
                mx={"auto"}
            >
                <Avatar src={userProfile.profilePicUrl} name={userProfile.username} alt="Profile Pic" />
            </AvatarGroup>
            <VStack alignItems={"start"} gap={2} mx={"auto"} flex={1}>
                ...
                >
                    ...
                    {
                        visitingAnotherProfeandAuth && <Flex gap={4} alignItems={"center"} justifyContent={"center"}>
                            <Button
                                bg={"blue.500"}
                                color={"white"}
                                _hover={{
